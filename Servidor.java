...
public class Servidor {
    ...
    public static void main(String[] args) {
        try {
            ...
            ServerSocket otrosservidores = new ServerSocket(puertoservidores);
            ServerSocket serDns = new ServerSocket(Dns);
            System.out.println("Servidor esperando conexion...");
            Socket socketCliente = servidor.accept();
            //Socket socketdns = serDns.accept();
           ...
           // out.println("OK CLIST " + listacontactosjorge.get(0));
            ...
            if(userl.equals("jorge.v")){
              ...
              for(int i=0; i < listacontactosjorge.size(); i++){
                ...
                JOptionPane.showMessageDialog(null, listacontactosjorge.get(i).toString());
                //out.println();
              }
              ...
              for(int i=0; i < listacontactosmelissa.size(); i++){
                ...
                JOptionPane.showMessageDialog(null, listacontactosmelissa.get(i).toString());
              }
              ...
              for(int i=0; i < listacontactosnick.size(); i++){
                ...
                JOptionPane.showMessageDialog(null, listacontactosnick.get(i).toString());
              }
            }else{
            ...
            if(userl.equals("jorge.v")){
              if (emailsjorge.equals(null)){
                ...
                for(int i=0; i<emailsjorge.size(); i++){
                  ...
                  JOptionPane.showMessageDialog(null, emailsjorge.get(i).toString());
                }
              }
            }else if(userl.equals("melissa08")){
              if (emailsmelissa.equals(null)){
                ...
                for(int i=0; i<emailsmelissa.size(); i++){
                  ...
                  JOptionPane.showMessageDialog(null, emailsmelissa.get(i));
                }
              }
            }else if(userl.equals("nick08")){
              if (emailsnick.equals(null)){
                ...
                for(int i=0; i<emailsnick.size(); i++){
                  ...
                  JOptionPane.showMessageDialog(null, emailsnick.get(i));
                }
              }
            }else{
              JOptionPane.showMessageDialog(null, "No hay Mensajes", "Error!", JOptionPane.ERROR_MESSAGE);
            ...
            String[] contactodeotroservidor = contacto.split("@");
            String usuarionuevo = contactodeotroservidor[0];
            String servidornuevo = contactodeotroservidor[1];

            //Verifica la informacion para agregar un contacto "NEWCONT"
            // if (Arrays.asList(contactodeotroservidor).contains("hogwarts"){
            //   Socket socketotroServidor = otrosservidores.accept();
            //
            // }
            if (contacto.equals("jorge.v")){
              if (listacontactosjorge.contains(contacto)){
              ...
              if (listacontactosmelissa.contains(contacto)){
                out.println("NEWCONT ERROR 109 " + contacto);
              }else{
              ...
              if (listacontactosnick.contains(contacto)){
                out.println("NEWCONT ERROR 109 " + contacto);
              }else{
